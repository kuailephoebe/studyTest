...
//                @Override
        ...
        public static void main(String[] args) throws IOException {
                ...
                DistributedCache.addFileToClassPath(new Path("/tmp/mysql-connector-java-5.1.38.jar"), conf);
                ...
                DBConfiguration.configureDB(conf, "com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/mldn",
                                "root", "123456");
